...
badd +37 ft_atoi.c
badd +22 ft_memchr.c
badd +13 ft_isalpha.c
badd +13 ft_isprint.c
badd +13 ft_memccpy.c
badd +25 ft_memcmp.c
badd +0 ~/Desktop/libft/ft_memcpy.c
argglobal
silent! argdel *
$argadd Makefile
edit ~/Desktop/libft/ft_memcpy.c
...
exe 'vert 1resize ' . ((&columns * 22 + 182) / 364)
exe 'vert 2resize ' . ((&columns * 170 + 182) / 364)
exe '3resize ' . ((&lines * 37 + 29) / 59)
exe 'vert 3resize ' . ((&columns * 170 + 182) / 364)
exe '4resize ' . ((&lines * 19 + 29) / 59)
exe 'vert 4resize ' . ((&columns * 170 + 182) / 364)
argglobal
enew
file ~/Desktop/libft/
let s:cpo_save=&cpo
...
wincmd w
argglobal
if bufexists('~/Desktop/libft/libft.h') | buffer ~/Desktop/libft/libft.h | else | edit ~/Desktop/libft/libft.h | endif
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
wincmd w
argglobal
if bufexists('~/Desktop/libft/Makefile') | buffer ~/Desktop/libft/Makefile | else | edit ~/Desktop/libft/Makefile | endif
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
